...
set	BeamLevel4	[SectionProperty W21X201]; 
set	BeamLevel5	[SectionProperty W30X148]; 
set	BeamLevel6	[SectionProperty W30X124]; 
set	BeamLevel7	[SectionProperty W21X147]; 
set	BeamLevel8	[SectionProperty W21X147]; 
set	BeamLevel9	[SectionProperty W18X130]; 
set	BeamLevel10	[SectionProperty W14X145]; 
set	BeamLevel11	[SectionProperty W14X53]; 
