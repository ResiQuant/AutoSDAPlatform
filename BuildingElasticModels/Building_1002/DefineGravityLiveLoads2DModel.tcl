...
load	9302	0	[expr -1*$LeaningColumnLiveLoadFloor3]	0; 
load	9402	0	[expr -1*$LeaningColumnLiveLoadFloor4]	0; 
load	9502	0	[expr -1*$LeaningColumnLiveLoadFloor5]	0; 
load	9602	0	[expr -1*$LeaningColumnLiveLoadFloor6]	0; 
load	9702	0	[expr -1*$LeaningColumnLiveLoadFloor7]	0; 
load	9802	0	[expr -1*$LeaningColumnLiveLoadFloor8]	0; 
