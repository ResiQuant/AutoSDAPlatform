...
node	10102	[expr 9*$BayWidth]	[expr 0*$FirstStory]; 	# Level 1
node	10202	[expr 9*$BayWidth]	[expr 1*$FirstStory]; 	# Level 2
node	10302	[expr 9*$BayWidth]	[expr 1*$FirstStory+1*$TypicalStory];	# Level 3
node	10402	[expr 9*$BayWidth]	[expr 1*$FirstStory+2*$TypicalStory];	# Level 4
node	10502	[expr 9*$BayWidth]	[expr 1*$FirstStory+3*$TypicalStory];	# Level 5
node	10602	[expr 9*$BayWidth]	[expr 1*$FirstStory+4*$TypicalStory];	# Level 6
node	10702	[expr 9*$BayWidth]	[expr 1*$FirstStory+5*$TypicalStory];	# Level 7
node	10802	[expr 9*$BayWidth]	[expr 1*$FirstStory+6*$TypicalStory];	# Level 8
node	10902	[expr 9*$BayWidth]	[expr 1*$FirstStory+7*$TypicalStory];	# Level 9
node	101002	[expr 9*$BayWidth]	[expr 1*$FirstStory+8*$TypicalStory];	# Level 10
node	101102	[expr 9*$BayWidth]	[expr 1*$FirstStory+9*$TypicalStory];	# Level 11

# puts "Nodes for leaning column defined" 

# Define extra nodes needed to define leaning column springs 
node	102202	[expr 9*$BayWidth]	[expr 1*$FirstStory+0*$TypicalStory];	# Node below floor level 2
node	102402	[expr 9*$BayWidth]	[expr 1*$FirstStory+0*$TypicalStory];	# Node above floor level 2
node	103202	[expr 9*$BayWidth]	[expr 1*$FirstStory+1*$TypicalStory];	# Node below floor level 3
node	103402	[expr 9*$BayWidth]	[expr 1*$FirstStory+1*$TypicalStory];	# Node above floor level 3
node	104202	[expr 9*$BayWidth]	[expr 1*$FirstStory+2*$TypicalStory];	# Node below floor level 4
node	104402	[expr 9*$BayWidth]	[expr 1*$FirstStory+2*$TypicalStory];	# Node above floor level 4
node	105202	[expr 9*$BayWidth]	[expr 1*$FirstStory+3*$TypicalStory];	# Node below floor level 5
node	105402	[expr 9*$BayWidth]	[expr 1*$FirstStory+3*$TypicalStory];	# Node above floor level 5
node	106202	[expr 9*$BayWidth]	[expr 1*$FirstStory+4*$TypicalStory];	# Node below floor level 6
node	106402	[expr 9*$BayWidth]	[expr 1*$FirstStory+4*$TypicalStory];	# Node above floor level 6
node	107202	[expr 9*$BayWidth]	[expr 1*$FirstStory+5*$TypicalStory];	# Node below floor level 7
node	107402	[expr 9*$BayWidth]	[expr 1*$FirstStory+5*$TypicalStory];	# Node above floor level 7
node	108202	[expr 9*$BayWidth]	[expr 1*$FirstStory+6*$TypicalStory];	# Node below floor level 8
node	108402	[expr 9*$BayWidth]	[expr 1*$FirstStory+6*$TypicalStory];	# Node above floor level 8
node	109202	[expr 9*$BayWidth]	[expr 1*$FirstStory+7*$TypicalStory];	# Node below floor level 9
node	109402	[expr 9*$BayWidth]	[expr 1*$FirstStory+7*$TypicalStory];	# Node above floor level 9
node	1010202	[expr 9*$BayWidth]	[expr 1*$FirstStory+8*$TypicalStory];	# Node below floor level 10
node	1010402	[expr 9*$BayWidth]	[expr 1*$FirstStory+8*$TypicalStory];	# Node above floor level 10
node	1011202	[expr 9*$BayWidth]	[expr 1*$FirstStory+9*$TypicalStory];	# Node below floor level 11
