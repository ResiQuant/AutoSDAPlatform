...
node	81002	[expr 7*$BayWidth]	[expr 1*$FirstStory+8*$TypicalStory];	# Level 10
node	81102	[expr 7*$BayWidth]	[expr 1*$FirstStory+9*$TypicalStory];	# Level 11
...
node	89402	[expr 7*$BayWidth]	[expr 1*$FirstStory+7*$TypicalStory];	# Node above floor level 9
node	810202	[expr 7*$BayWidth]	[expr 1*$FirstStory+8*$TypicalStory];	# Node below floor level 10
node	810402	[expr 7*$BayWidth]	[expr 1*$FirstStory+8*$TypicalStory];	# Node above floor level 10
node	811202	[expr 7*$BayWidth]	[expr 1*$FirstStory+9*$TypicalStory];	# Node below floor level 11
