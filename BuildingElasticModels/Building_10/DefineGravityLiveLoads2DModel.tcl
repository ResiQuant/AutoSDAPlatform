...
load	6502	0	[expr -1*$LeaningColumnLiveLoadFloor5]	0; 
load	6602	0	[expr -1*$LeaningColumnLiveLoadFloor6]	0; 
load	6702	0	[expr -1*$LeaningColumnLiveLoadFloor7]	0; 
load	6802	0	[expr -1*$LeaningColumnLiveLoadFloor8]	0; 
