...
############  additional code for more eigen checks ############
	set num_modes 5 
	set filename "modal_results.out"
	...
	set lambdas [eigen -genBandArpack $num_modes]
	...
	if {$filename!=""} {
		...
		set fp [open $recorderdir/$filename w]
	...
	proc print_modes { num_modes ctrl_nodes dof recorderdir filename} {
	...
	print_modes $num_modes $ctrl_nodes $dof $recorderdir $filename_modes	