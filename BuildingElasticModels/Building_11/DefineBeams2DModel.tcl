...
set	BeamLevel3	[SectionProperty W12X106]; 
set	BeamLevel4	[SectionProperty W12X106]; 
set	BeamLevel5	[SectionProperty W18X65]; 
set	BeamLevel6	[SectionProperty W16X57]; 
set	BeamLevel7	[SectionProperty W16X45]; 
set	BeamLevel8	[SectionProperty W14X38]; 
