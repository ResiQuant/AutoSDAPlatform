...
set	ExteriorColumnStory1	[SectionProperty W12X305]; 
set	ExteriorColumnStory2	[SectionProperty W12X305]; 
set	ExteriorColumnStory3	[SectionProperty W12X279]; 
set	ExteriorColumnStory4	[SectionProperty W12X279]; 
set	ExteriorColumnStory5	[SectionProperty W12X279]; 
set	ExteriorColumnStory6	[SectionProperty W12X252]; 
set	ExteriorColumnStory7	[SectionProperty W14X193]; 
set	ExteriorColumnStory8	[SectionProperty W12X190]; 
set	ExteriorColumnStory9	[SectionProperty W14X74]; 


# Define interior column section sizes 
set	InteriorColumnStory1	[SectionProperty W14X342]; 
set	InteriorColumnStory2	[SectionProperty W14X342]; 
set	InteriorColumnStory3	[SectionProperty W14X311]; 
set	InteriorColumnStory4	[SectionProperty W14X311]; 
set	InteriorColumnStory5	[SectionProperty W14X311]; 
set	InteriorColumnStory6	[SectionProperty W14X283]; 
set	InteriorColumnStory7	[SectionProperty W12X279]; 
set	InteriorColumnStory8	[SectionProperty W14X211]; 
set	InteriorColumnStory9	[SectionProperty W12X120]; 
...
element	elasticBeamColumn	39192	9111	9121	[expr 1*[lindex $InteriorColumnStory1 2]]	$Es	[lindex $InteriorColumnStory1 6]	$PDeltaTransf; 
element	elasticBeamColumn	3101102	10111	10121	[expr 1*[lindex $ExteriorColumnStory1 2]]	$Es	[lindex $ExteriorColumnStory1 6]	$PDeltaTransf; 
...
element	elasticBeamColumn	39293	9121	9131	[expr 1*[lindex $InteriorColumnStory2 2]]	$Es	[lindex $InteriorColumnStory2 6]	$PDeltaTransf; 
element	elasticBeamColumn	3102103	10121	10131	[expr 1*[lindex $ExteriorColumnStory2 2]]	$Es	[lindex $ExteriorColumnStory2 6]	$PDeltaTransf; 
...
element	elasticBeamColumn	39394	9131	9141	[expr 1*[lindex $InteriorColumnStory3 2]]	$Es	[lindex $InteriorColumnStory3 6]	$PDeltaTransf; 
element	elasticBeamColumn	3103104	10131	10141	[expr 1*[lindex $ExteriorColumnStory3 2]]	$Es	[lindex $ExteriorColumnStory3 6]	$PDeltaTransf; 
...
element	elasticBeamColumn	39495	9141	9151	[expr 1*[lindex $InteriorColumnStory4 2]]	$Es	[lindex $InteriorColumnStory4 6]	$PDeltaTransf; 
element	elasticBeamColumn	3104105	10141	10151	[expr 1*[lindex $ExteriorColumnStory4 2]]	$Es	[lindex $ExteriorColumnStory4 6]	$PDeltaTransf; 
...
element	elasticBeamColumn	39596	9151	9161	[expr 1*[lindex $InteriorColumnStory5 2]]	$Es	[lindex $InteriorColumnStory5 6]	$PDeltaTransf; 
element	elasticBeamColumn	3105106	10151	10161	[expr 1*[lindex $ExteriorColumnStory5 2]]	$Es	[lindex $ExteriorColumnStory5 6]	$PDeltaTransf; 
...
element	elasticBeamColumn	39697	9161	9171	[expr 1*[lindex $InteriorColumnStory6 2]]	$Es	[lindex $InteriorColumnStory6 6]	$PDeltaTransf; 
element	elasticBeamColumn	3106107	10161	10171	[expr 1*[lindex $ExteriorColumnStory6 2]]	$Es	[lindex $ExteriorColumnStory6 6]	$PDeltaTransf; 
...
element	elasticBeamColumn	39798	9171	9181	[expr 1*[lindex $InteriorColumnStory7 2]]	$Es	[lindex $InteriorColumnStory7 6]	$PDeltaTransf; 
element	elasticBeamColumn	3107108	10171	10181	[expr 1*[lindex $ExteriorColumnStory7 2]]	$Es	[lindex $ExteriorColumnStory7 6]	$PDeltaTransf; 
...
element	elasticBeamColumn	39899	9181	9191	[expr 1*[lindex $InteriorColumnStory8 2]]	$Es	[lindex $InteriorColumnStory8 6]	$PDeltaTransf; 
element	elasticBeamColumn	3108109	10181	10191	[expr 1*[lindex $ExteriorColumnStory8 2]]	$Es	[lindex $ExteriorColumnStory8 6]	$PDeltaTransf; 
...
element	elasticBeamColumn	399910	9191	9201	[expr 1*[lindex $InteriorColumnStory9 2]]	$Es	[lindex $InteriorColumnStory9 6]	$PDeltaTransf; 
element	elasticBeamColumn	31091010	10191	10201	[expr 1*[lindex $ExteriorColumnStory9 2]]	$Es	[lindex $ExteriorColumnStory9 6]	$PDeltaTransf; 
