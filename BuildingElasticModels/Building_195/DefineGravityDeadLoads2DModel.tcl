...
load	4202	0	[expr -1*$LeaningColumnDeadLoadFloor2]	0; 
load	4302	0	[expr -1*$LeaningColumnDeadLoadFloor3]	0; 
load	4402	0	[expr -1*$LeaningColumnDeadLoadFloor4]	0; 
load	4502	0	[expr -1*$LeaningColumnDeadLoadFloor5]	0; 
load	4602	0	[expr -1*$LeaningColumnDeadLoadFloor6]	0; 
