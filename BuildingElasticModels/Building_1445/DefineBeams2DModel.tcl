...
set	BeamLevel4	[SectionProperty W14X132]; 
set	BeamLevel5	[SectionProperty W14X145]; 
set	BeamLevel6	[SectionProperty W14X132]; 
set	BeamLevel7	[SectionProperty W12X136]; 
set	BeamLevel8	[SectionProperty W18X71]; 
set	BeamLevel9	[SectionProperty W18X50]; 
