...
# create element IDs as a function of first input eleID (8 per panel zone)
    ...
    set A_PZ [expr 50*50]; # area of panel zone element (make much larger than A of frame elements)
    set Ipz [expr 50/12*pow(50,3)];  # moment of intertia of panel zone element (make much larger than I of frame elements)
